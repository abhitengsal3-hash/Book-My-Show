...
This is the **Book My Show App Deployment** project! in this project i have deployed **Book My Show-clone application** using modern DevOps tools and practices, following a **DevSecOps** approach.  
